...
public class CameraList : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          nrc_interfacePINVOKE.delete_CameraList(swigCPtr);
        }
  ...
  public string currentName {
    set {
      nrc_interfacePINVOKE.CameraList_currentName_set(swigCPtr, value);
      if (nrc_interfacePINVOKE.SWIGPendingException.Pending) throw nrc_interfacePINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      string ret = nrc_interfacePINVOKE.CameraList_currentName_get(swigCPtr);
      if (nrc_interfacePINVOKE.SWIGPendingException.Pending) throw nrc_interfacePINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public int listNum {
    set {
      nrc_interfacePINVOKE.CameraList_listNum_set(swigCPtr, value);
    } 
    get {
      int ret = nrc_interfacePINVOKE.CameraList_listNum_get(swigCPtr);
      return ret;
    } 
  }

  public CameraList() : this(nrc_interfacePINVOKE.new_CameraList(), true) {
  }
